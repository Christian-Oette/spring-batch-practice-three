...
public class JobMonitoringController {
    ...
    public JobMonitoringController(JobRepository jobRepository, JobExplorer jobExplorer,
    ...
    public JsonWrapper getJobNames() {
        //return new JsonWrapper(jobExplorer.getJobNames());
    ...
    public void startSimpleJobWithParameter(@PathVariable String parameter) {
        JobParameters jobParameters = new JobParametersBuilder()
                .addParameter("parameter", new JobParameter(parameter))
                .toJobParameters();
